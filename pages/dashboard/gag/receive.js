...
export default function GAGReceive() {
	const [selectedToken, setSelectedToken] = useState("GAG");
	...
	const walletAddress = "gag1qxy2kgdygjrsqtzq2n0yrf2493p83kkfjhx0wlh";

	const supportedTokens = [
		{ symbol: "GAG", name: "GALIRA GOLD Token", network: "Ethereum" },
